...
class MyDialog(wx.Dialog):
    ...
    def __InitUI(self):  
        ...
        matrices_b = [_("Pkw_E_O : Car trips adults base case : 1"),
                      ...
                      _("MIV_Gesamtwiderstand_O : Car impedance base case : 35"),
                      _("OEV_Gesamtwiderstand_O : PT impedance base case : 37"),
                      _("BH_Tag_O : PT headway base case : 39"),
                      _("BH_Spitze_O : PT headway peak hour base case : 41"),
                      _("OEV_Widerstand_O : PT impedance base case : 43")]
        matrices_p = [_("Pkw_E_M : Car trips adults planning case : 2"),
                      _("OEV_E_M : PT rides adults planning case : 11"),
                      _("MIV_Gesamtwiderstand_M : Car impedance planning case : 36"),
                      _("OEV_Gesamtwiderstand_M : PT impedance planning case : 38"),
                      _("BH_Tag_M : PT headway planning case : 40"),
                      _("BH_Spitze_M : PT headway peak hour planning case : 42"),
                      _("OEV_Widerstand_M : PT impedance planning case : 44"),
