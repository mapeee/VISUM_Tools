...
class InfoFrame(wx.Frame):
    def __init__(self, title):
        ...
        sizer.Add(wx.StaticText(self,label= _("05.09.2025")),0,wx.LEFT,10)
        sizer.AddSpacer(2)
...
class MyDialog(wx.Dialog):
    ...
    def OnHelp(self,event):
        try:
            os.startfile(addIn.DirectoryPath + _("HelpMapPTJourneys.htm"))
        except:
...
def _TestJourneys():
    if Visum.Net.VehicleJourneys.CountActive > 2000:
        addIn.ReportMessage(_("To many active VehicleJourneys!"))
        return False
    elif Visum.Net.VehicleJourneys.CountActive == 0:
...
if addIn.State != AddInState.OK:
    ...
    try:
        ...
        if CheckNetwork():
            dialog_1 = MyDialog(None, _("Create Journey Graphic"))
